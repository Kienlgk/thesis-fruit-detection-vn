...
\begin{center}
    ...
    \end{figure}
\end{center}
\footnotetext{Nguồn: \url{http://cs231n.github.io/neural-networks-1/}}
...
\begin{figure}[H]
  ...
  \label{chap2:fig08}    
\end{figure}
\footnotetext{Nguồn: \url{http://brohrer.github.io/how_convolutional_neural_networks_work.html}} 
...
\begin{center}
    ...
    \end{figure}
\end{center}
\footnotetext{Nguồn: \url{https://machinelearningcoban.com/2017/02/24/mlp/}}
...
\begin{center}
    ...
    \end{figure}
\end{center}
\footnotetext{Nguồn: \url{http://www.wildml.com/2015/11/understanding-convolutional-neural-networks-for-nlp/}}
...
\begin{center}
    ...
    \end{figure}
\end{center}
\footnotetext{Nguồn: \url{http://cs231n.stanford.edu/}}
...
\begin{center}
    ...
    \end{figure}
\end{center}
\footnotetext{Nguồn: \url{https://brohrer.github.io/how_convolutional_neural_networks_work.html}}
...
\begin{center}
    ...
    \end{figure}
\end{center}
\footnotetext{Nguồn: \url{http://cs231n.github.io/convolutional-networks/}}
